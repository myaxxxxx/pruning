...
class TransformerEncoder(nn.Module):
    ...
    def extract_features(
        ...
        select_layer = len(self.layers) - self.pruning_init_layer
            ...
            if not self.training or (dropout_probability > self.layerdrop):
                ...
                if (corpus_key is None) or (
                    ...
                    if i >= self.pruning_init_layer:
                        ...
                        current_rate = self.pruning_min_rate + (self.pruning_max_rate - self.pruning_min_rate) / select_layer * (i - self.pruning_init_layer )
                        left_tokens = math.ceil(current_rate * (N)) #  N = token_num
