...
class TransformerEncoderShareEncBase(FairseqEncoder):
    """
...
class TransformerModelShareEncBase(TransformerModelBase):
    @classmethod
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return TransformerEncoderShareEncBase(cfg, src_dict, embed_tokens)