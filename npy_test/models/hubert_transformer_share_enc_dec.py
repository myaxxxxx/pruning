...
from fairseq.models.speech_to_text.s2t_transformer import Conv1dSubsampler # del TransformerDecoderScriptable
...
@register_model("hubert_transformer_share_enc_dec")
...
class HubertTransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary=None, embed_tokens=None):
        ...
        if args.conv_kernel_sizes:
            ...
            self.dim_proj1 = nn.Linear(hubert_args.model.encoder_embed_dim, args.encoder_embed_dim)
    ...
    def _forward(self, src_tokens, src_lengths, mode, return_all_hiddens=False):
        ...
        for layer in self.transformer_layers:
            x = self.transformer_layers[0](x, encoder_padding_mask)
            if return_all_hiddens:
                encoder_states.append(x)
...
@register_model_architecture(model_name="hubert_transformer_share_enc_dec", arch_name="hubert_transformer_share_enc_dec")
