...
# from .transformers_encoder import HyTransformerEncoderBase
# import HyTransformerEncoderBase
...
class PTransformerModelBase(FairseqEncoderDecoderModel):
    """
...
# config.prefix_length, config.encoder_layers * 2 * config.encoder_embed_dim
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return PTransformerEncoderBase(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return PTransformerDecoderBase(
            cfg,
            tgt_dict,
            embed_tokens,
