...
class TransformerSentenceEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.layer_norm_first:
            ...
            # but = torch.gather(x, dim=1, index=index)  # [B, left_tokens, C]  
            # d = torch.rand(N, b, c).to(but.device)
            ...
            # self_attn_padding_mask1 = torch.gather(self_attn_padding_mask, dim=1, index=true_idx)       
