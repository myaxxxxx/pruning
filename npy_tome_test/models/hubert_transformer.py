...
@register_model("hubert_transformer_pruning_test")
...
@register_model_architecture(model_name="hubert_transformer_pruning_test", arch_name="hubert_transformer_pruning_test")
